  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text>
          developer, I like the impact it creates on the world. I am expert in
          HTML, REACT.JS AND REDUX
        </Text>
        <Text>
          One of my strongest skill is creativity and it helps me a lot in web
          design I have
        </Text>
        <Text>
          created various end to end website clone using{" "}
